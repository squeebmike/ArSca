...
assert.match(dashboard, /'overview','display','browse','inventory','research','pos','alerts','wantlist','locations','restock','grading','sets','events','pulllists'/, 'employees must be able to reach the grading tab');
