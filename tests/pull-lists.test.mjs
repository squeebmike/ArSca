...
assert.match(dashboard, /'overview','display','browse','inventory','research','pos','whatnot','scout','alerts','wantlist','locations','restock','grading','sets','events','pulllists'/, 'employees must be able to reach the pull lists tab');
