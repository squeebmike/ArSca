...
assert.match(dashboard, /'overview','display','browse','inventory','research','pos','whatnot','scout','alerts','wantlist','locations','restock','grading','sets','events'/, 'employees must be able to reach the events tab');
