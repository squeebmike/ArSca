...
assert.match(dashboard, /const storefrontUrl = new URL\('https:\/\/themanapocket\.com\/shop'\);/, 'the fallback for anything without an exact match must be the real shop route, not the homepage or a third-party search');
