...
// Labels must actually render a scannable barcode via JsBarcode, not just text.
assert.match(dashboard, /JsBarcode\(canvas, b\.sku \|\| b\.id, \{ format:'CODE128'/, 'printed labels must render a real CODE128 barcode');
